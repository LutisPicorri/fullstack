...
describe('favorite blog', () => {
  ...
  test('when list has multiple blogs, returns the one with most likes', () => {
    ...
    assert.deepStrictEqual(result, listWithMultipleBlogs[2]) // The one with 12 likes
  })
...
describe('most blogs', () => {
  ...
  test('when list has multiple authors, returns the one with most blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has multiple authors, returns the one with most total likes', () => {
